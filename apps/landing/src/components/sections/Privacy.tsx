...
export default function Privacy() {
  ...
  return (
    <section id="privacy" className="py-24 md:py-32 bg-[#353935] border-t border-white/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="rounded-3xl bg-[#2C302C] border border-white/10 p-6 sm:p-8 mb-12 shadow-xl">
          <div className="text-xs font-mono text-[#C4C7C0] uppercase tracking-wider mb-6 flex items-center justify-between pb-3 border-b border-white/10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-2xl bg-[#353935] border border-white/10 flex flex-col justify-between shadow-2xs">
              <span className="text-[10px] font-mono text-[#D1E043] font-bold">01 · SOURCE</span>
              <h4 className="text-sm font-semibold text-[#F5F5F0] mt-2 mb-1">Hardware Capture</h4>
              <p className="text-xs text-[#A9ACA4] leading-relaxed">Direct WASAPI &amp; CoreAudio loopback stream without virtual cable bloat.</p>
            </div>

            <div className="p-4 rounded-2xl bg-[#353935] border border-white/10 flex flex-col justify-between shadow-2xs">
              <span className="text-[10px] font-mono text-[#D1E043] font-bold">02 · INFERENCE</span>
              <h4 className="text-sm font-semibold text-[#F5F5F0] mt-2 mb-1">Local Whisper Engine</h4>
              <p className="text-xs text-[#A9ACA4] leading-relaxed">Zero cloud streaming. Speech converted directly in local RAM.</p>
            </div>

            <div className="p-4 rounded-2xl bg-[#353935] border border-white/10 flex flex-col justify-between shadow-2xs">
              <span className="text-[10px] font-mono text-[#D1E043] font-bold">03 · SYNTHESIS</span>
              <h4 className="text-sm font-semibold text-[#F5F5F0] mt-2 mb-1">Local Ollama / BYOK</h4>
              <p className="text-xs text-[#A9ACA4] leading-relaxed">Extracts decisions &amp; action items on your hardware or via personal API keys.</p>
            </div>

            <div className="p-4 rounded-2xl bg-[#2E352E] border border-[#D1E043]/40 flex flex-col justify-between shadow-md">
              <span className="text-[10px] font-mono text-[#D1E043] font-bold">04 · VAULT</span>
              <h4 className="text-sm font-semibold text-[#F5F5F0] mt-2 mb-1">Local SQLite DB</h4>
              <p className="text-xs text-[#C4C7C0] leading-relaxed">All notes, embeddings, and snapshots stored exclusively on your SSD.</p>
            </div>
          ...
          {pillars.map((p, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-[#2C302C] border border-white/10 hover:border-[#D1E043]/40 transition-all shadow-md"
              >
                ...
                <h3 className="font-serif text-lg font-normal text-[#F5F5F0] mb-2">{p.title}</h3>
                <p className="text-xs sm:text-[13px] text-[#A9ACA4] leading-relaxed">{p.desc}</p>
              </motion.div>
            );
          })}
        </div>
