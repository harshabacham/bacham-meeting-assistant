  ...
  return (
    <footer className="border-t border-white/[0.06] bg-[#07080A] py-14 relative z-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-white/[0.06]">
          ...
          <div className="md:col-span-5 space-y-3">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="font-bold tracking-tight text-lg text-[#FAF9F5]">
                BACHAM
              </span>
            </Link>
            <p className="text-xs sm:text-[13px] text-[#8E9099] leading-relaxed max-w-sm">
            ...
            <div className="pt-2 flex items-center gap-2 text-xs font-semibold text-[#8E9099]">
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-[#FAF9F5]">
              Product
            </h4>
            <ul className="space-y-2 text-xs text-[#8E9099]">
              <li>
                <Link href="#features" className="hover:text-[#FAF9F5] transition-colors">
                  Core Features
                </Link>
              </li>
              <li>
                <Link href="#how-it-works" className="hover:text-[#FAF9F5] transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
                <Link href="#comparison" className="hover:text-[#FAF9F5] transition-colors">
                  Bacham vs. Cloud Bots
                </Link>
              </li>
              <li>
                <Link href="#downloads" className="hover:text-[#FAF9F5] transition-colors">
                  Downloads &amp; Releases
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-2 text-xs text-[#8E9099]">
              <li>
                <a
                  ...
                  className="hover:text-[#FAF9F5] transition-colors flex items-center gap-1.5"
                >
                  <Star size={13} className="text-[#E2B774]" />
              ...
              <li>
                <Link href="#faq" className="hover:text-[#FAF9F5] transition-colors">
        ...
        {/* Bottom Strip */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#8E9099]">
