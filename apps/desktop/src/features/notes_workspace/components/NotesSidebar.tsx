import { Search, Plus, Pin, Trash2, Copy, MoreVertical, FileText, Folder as FolderIcon, FolderPlus, Layers, Edit2, Sparkles } from 'lucide-react';
            ...
            >
                <div className="flex flex-col gap-1 pr-6">
                    <div className="flex items-center gap-1.5 min-w-0">
                        ...
                        {note.isMeeting && <Sparkles size={11} className="text-primary shrink-0" />}
                        <span className={cn(
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {note.isMeeting && (
                            <span className="text-[9px] font-bold px-1.5 py-0.2 bg-primary/10 text-primary border border-primary/20 rounded">Meeting</span>
                        )}
