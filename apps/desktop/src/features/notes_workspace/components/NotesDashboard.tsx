...
export function NotesDashboard({ 
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-[var(--bg)] text-[var(--text-primary)] overflow-hidden font-sans relative selection:bg-[var(--surface-hover)]">
            ...
            {/* Sticky top bar - added safe padding to prevent overlapping with window controls */}
            <div className="h-11 shrink-0 flex items-center justify-between pl-5 sticky top-0 bg-[var(--bg)] relative z-[99999] pointer-events-none titlebar-safe-padding">
