    ...
    return (
      <div className="relative flex h-screen w-full items-center justify-center p-4 overflow-hidden select-none">
        ...
        <motion.div 
          ...
          className="relative z-10 w-full max-w-[340px] overflow-hidden rounded-3xl border border-white/10 bg-[#28282B] shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_1px_0_rgba(255,255,255,0.1)] p-6 text-white"
        >
          {/* Ambient Specular Glass Sheen */}
          <div className="pointer-events-none absolute inset-x-0 top-0 h-28 bg-gradient-to-b from-white/[0.05] to-transparent rounded-t-3xl" />
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center p-4 selection:bg-white/20 selection:text-white overflow-y-auto">
      ...
      <motion.div
        ...
        transition={{ duration: 0.3 }}
        className="relative z-10 w-full max-w-[340px] overflow-hidden rounded-3xl border border-white/10 bg-[#28282B] p-6 text-white shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_1px_0_rgba(255,255,255,0.1)] my-auto"
      >
        {/* Ambient Specular Glass Sheen */}
        <div className="pointer-events-none absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-white/[0.05] to-transparent rounded-t-3xl" />

        {/* Title */}
        <div className="relative z-10 text-center mb-5">
          <h1 className="text-2xl font-bold tracking-tight text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.2)]">
        ...
        {/* Error Banner */}
        {error && (
          <div className="relative z-10 mb-4 rounded-2xl border border-red-400/30 bg-red-500/20 p-2.5 text-xs text-red-100 text-center backdrop-blur-md shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.2)]">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleEmailAuth} className="relative z-10 space-y-3">
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-white/85">Email Address</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/10 bg-black/30 hover:bg-black/40 focus:bg-black/50 py-2.5 pl-10 pr-3.5 text-xs text-white placeholder:text-white/40 outline-none transition-all focus:border-white/30 focus:ring-2 focus:ring-white/10 shadow-[inset_0_1px_2px_rgba(0,0,0,0.3)]"
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-white/85">Password</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/10 bg-black/30 hover:bg-black/40 focus:bg-black/50 py-2.5 pl-10 pr-10 text-xs text-white placeholder:text-white/40 outline-none transition-all focus:border-white/30 focus:ring-2 focus:ring-white/10 shadow-[inset_0_1px_2px_rgba(0,0,0,0.3)]"
                placeholder="••••••••"
                required
              />
              <button
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 flex items-center justify-center gap-2 rounded-2xl bg-white hover:bg-white/95 py-2.5 text-xs font-semibold text-neutral-950 transition-all active:scale-[0.98] disabled:opacity-50 shadow-[0_4px_16px_rgba(0,0,0,0.25)] cursor-pointer"
          >
            {loading ? (
              <>
        ...
        <div className="relative z-10 my-4">
          ...
          <div className="relative flex justify-center text-[10px]">
            <span className="px-3 py-0.5 bg-[#28282B] text-white/60 font-medium uppercase tracking-wider rounded-full border border-white/10">
              or continue with
            </span>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-2">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/[0.06] hover:bg-white/[0.10] py-2.5 text-xs font-medium text-white transition-all active:scale-[0.98] cursor-pointer"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/[0.06] hover:bg-white/[0.10] py-2.5 text-xs font-medium text-white transition-all active:scale-[0.98] disabled:opacity-50 cursor-pointer"
          >
        ...
        <div className="relative z-10 mt-4 text-center text-xs text-white/70">
          ...
          <button
            ...
            className="font-semibold text-white hover:underline transition-colors ml-0.5 cursor-pointer underline-offset-2"
          >
