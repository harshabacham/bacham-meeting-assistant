...
export const LoginPage = () => {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      // In Tauri desktop environment: open system browser with local loopback listener
      ...
      const waitForResult = new Promise<{ token?: string; error?: string }>((resolve, reject) => {
