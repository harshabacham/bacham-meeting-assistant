...
export const LoginPage = () => {
    ...
    return (
      <div className="relative flex h-screen w-full items-center justify-center p-4 overflow-hidden select-none">
        ...
        <motion.div 
          ...
          className="relative z-10 w-full max-w-[340px] overflow-hidden rounded-2xl border border-white/40 bg-white/35 backdrop-blur-xl shadow-xl p-5 text-white"
        >
          <ProfileSetup 
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center p-4 selection:bg-white/20 selection:text-white overflow-y-auto">
      ...
      {/* Simple, Clean Frosted Glass Card */}
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.3 }}
        className="relative z-10 w-full max-w-[340px] rounded-2xl border border-white/40 bg-gradient-to-b from-white/40 via-white/30 to-white/20 backdrop-blur-xl p-6 text-white shadow-xl my-auto"
      >
        {/* Title */}
        ...
        {/* Error Banner */}
        {error && (
          <div className="mb-4 rounded-xl border border-red-400/30 bg-red-500/20 p-2.5 text-xs text-red-100 text-center backdrop-blur-md">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleEmailAuth} className="space-y-3">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/30 bg-white/25 py-2.5 pl-9 pr-3 text-xs text-white placeholder:text-white/60 outline-none transition-all focus:border-white/60 focus:bg-white/35 backdrop-blur-sm"
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/30 bg-white/25 py-2.5 pl-9 pr-9 text-xs text-white placeholder:text-white/60 outline-none transition-all focus:border-white/60 focus:bg-white/35 backdrop-blur-sm"
                placeholder="••••••••"
                required
              />
              <button
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 flex items-center justify-center gap-2 rounded-xl bg-white hover:bg-white/90 py-2.5 text-xs font-bold text-neutral-950 transition-all active:scale-[0.98] disabled:opacity-50 shadow-md cursor-pointer"
          >
            {loading ? (
              <>
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-[10px]">
            <span className="px-2.5 py-0.5 bg-white/25 backdrop-blur-sm text-white/85 font-semibold uppercase tracking-wider rounded-md border border-white/10">
              or continue with
            </span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/30 bg-white/25 hover:bg-white/35 py-2.5 text-xs font-semibold text-white transition-all active:scale-[0.98] backdrop-blur-sm cursor-pointer shadow-xs"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/30 bg-white/25 hover:bg-white/35 py-2.5 text-xs font-semibold text-white transition-all active:scale-[0.98] disabled:opacity-50 backdrop-blur-sm cursor-pointer shadow-xs"
          >
        ...
        <div className="mt-4 text-center text-xs text-white/80">
          ...
          <button
            ...
            className="font-bold text-white hover:underline transition-colors ml-0.5 cursor-pointer underline-offset-2"
          >
