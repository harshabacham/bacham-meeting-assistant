  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center p-4 selection:bg-white/20 selection:text-white overflow-y-auto">
      ...
      >
        ...
        {/* Error Banner */}
        {error && (
          <div className="mb-4 rounded-xl border border-red-400/25 bg-red-500/15 p-2.5 text-xs text-red-200 text-center">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleEmailAuth} className="space-y-3">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/15 bg-white/10 py-2 pl-9 pr-3 text-xs text-white placeholder:text-white/40 outline-none transition-all focus:border-white/40 focus:bg-white/15"
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/15 bg-white/10 py-2 pl-9 pr-9 text-xs text-white placeholder:text-white/40 outline-none transition-all focus:border-white/40 focus:bg-white/15"
                placeholder="••••••••"
                required
              />
              <button
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 flex items-center justify-center gap-2 rounded-xl bg-white hover:bg-white/90 py-2.5 text-xs font-semibold text-neutral-950 transition-all active:scale-[0.98] disabled:opacity-50 shadow-sm cursor-pointer"
          >
            {loading ? (
              <>
        ...
        <div className="space-y-2">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/10 hover:bg-white/15 py-2.5 text-xs font-medium text-white transition-all active:scale-[0.98] cursor-pointer"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/10 hover:bg-white/15 py-2.5 text-xs font-medium text-white transition-all active:scale-[0.98] disabled:opacity-50 cursor-pointer"
          >
        ...
        <div className="mt-4 text-center text-xs text-white/60">
          ...
          <button
            ...
            className="font-semibold text-white hover:underline transition-colors ml-0.5 cursor-pointer"
          >
