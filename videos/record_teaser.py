...
async def record():
    print("Starting Playwright 1080p 60fps recording for 45s 3D Isometric Clay Trailer...")
    ...
    async with async_playwright() as p:
        ...
        print("Recording 46.5 seconds of 1080p 3D Isometric Clay animation...")
        await page.wait_for_timeout(46500)
    ...
    for f in temp_files:
        if f.endswith(".webm"):
            ...
            print(f"SUCCESS: Saved 3D Isometric Clay Trailer to {dst} ({size_mb} MB)")
